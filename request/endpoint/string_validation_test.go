...
func TestStringValidation_Validate_Value(t *testing.T) {
	type fields struct {
		Value *string
	}
	type args struct {
...
func TestStringValidation_Validate_OneOf(t *testing.T) {
	type fields struct {
		OneOf []string
	}
	type args struct {
...
func TestStringValidation_Validate_RegEx(t *testing.T) {
	type fields struct {
		RegEx *string
	}
	type args struct {
